export default () => ({
  ...
  db: {
    ...
    "Certificato SPORTIVO": "I sanitari dello Studio Medico Izzo-Arduino sono autorizzati alle visite mediche e al rilascio del certificato medico per l'idoneità all'attività sportiva non agonistica.",
  ...
  get cards() {
    return typeof this.currentDb === 'string'
      ? this.currentDb
