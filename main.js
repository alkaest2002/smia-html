...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  var cards_default = () => ({
    ...
    currentCardIndex: 0,
    get currentDb() {
      return this.filteredDb || this.db["Certificati"];
    },
    get cards() {
